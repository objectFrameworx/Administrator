...
//==========================================================
exports.router_stat_output = function(req, processing_hosts, list_args ,callback) {
...
exports.router_rexec = function(req, server_user, server_user_pass, processing_cmds, processing_hosts, task,callback) {
	...
	(function loop() {
		if (i < task.length) {
			...
			rexec(processing_hosts, processing_cmds[i], router_connection_options, function(err){
				var local_args = [];
